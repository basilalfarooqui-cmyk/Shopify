/* ===========================================================================
   BLOOM — skin.js
   Small, dependency-free behaviour for the Bloom skincare site.
   =========================================================================== */
(function () {
  'use strict';
  ...
  /* --- purchase plan (one-off vs subscription) --------------------------
     A radio group in everything but markup, so it carries the ARIA itself
     and updates the price shown on the add-to-bag button. */
  var plans = $$('[data-plan]');
  if (plans.length) {
    var atcPrice = $('[data-atc-price]');
    plans.forEach(function (p) {
      p.addEventListener('click', function () {
        ...
        if (atcPrice) atcPrice.textContent = p.getAttribute('data-price') || '';
      });
    });
  }
